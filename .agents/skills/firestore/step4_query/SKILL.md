...
description: Firestore - Execute demo queries and present value-driven talk tracks.
---

# Firestore Step4 Query

This skill handles the step4 query phase for Firestore demos.
