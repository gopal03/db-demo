...
description: Firestore - Generate realistic mock data conforming to the schema and relationships.
---

# Firestore Step2 Data

This skill handles the step2 data phase for Firestore demos.
