...
description: Cloud SQL - Translate use-case configuration into schema definitions and DDL.
---

# Cloud SQL Step1 Schema

This skill handles the step1 schema phase for Cloud SQL demos.
